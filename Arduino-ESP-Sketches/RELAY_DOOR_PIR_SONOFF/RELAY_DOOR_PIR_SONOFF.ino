...
char const* server = "192.168.1.10";         // Mosquitto Server IP

// Topic Defines //
char const* TopicCOMRELAY1 = "/os/relay/1/com/";
char const* TopicSTATERELAY1 = "/os/relay/1/state/";
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    if (client.connect("RelayDoorPirGarden")) {     // ***NEEDS TO BE UNIQUE***
      Serial.println("MQTT Connected");
      Serial.println("MQTT Connected");
      // Once connected, publish an announcement...
      client.publish(outTopic, "ESP RelayDoorPirGarden Connected");
      // ... and resubscribe
